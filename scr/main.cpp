...
uint8_t basebeat    = 5;    // just constant for light-music
uint8_t max_bright  = 255;  // max number for brightness
uint8_t thisbeat    = 23;   // for music patter
uint8_t thatbeat    = 28;   // for music patter
uint8_t thisfade    = 3;    // How quickly does it fade? Lower = slower fade rate.
uint8_t thissat     = 255;  // The saturation, where 255 = brilliant colours.
uint8_t thisbri     = 255;  // brightness, 255 - max
